 ...
 * @author Eduardo
 */
public class CaballoCorreJPanel extends JPanel {
    ...
    public void iniciarAnimacion() {
        if ( temporizadorAnimacion == null ) {
            imagenActual = 1; // muestra la primera imagen

            // crea temporizador
            temporizadorAnimacion =
            new Timer( RETRASO_ANIMACION, (ActionListener) new ManejadorTimer());
